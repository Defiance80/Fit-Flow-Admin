...
class User extends Authenticatable {
     ...
     */
public function trainerClients()    {        return $this->belongsToMany(User::class, 'trainer_clients', 'trainer_id', 'client_id')            ->withPivot('status', 'subscribed_at', 'notes')            ->withTimestamps();    }
