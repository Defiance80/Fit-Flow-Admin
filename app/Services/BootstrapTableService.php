...
class BootstrapTableService {
    ...
    $dropdown .= '<button class="btn icon btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">';
    ...
    public static function editButton($url, bool $modal = false, $dataBsTarget = "#editModal", $customClass = null, $id = null, $iconClass = "fa fa-edit", $onClick = null) {
        $customClass = ["btn-primary edit-data" . " " . $customClass];
        $customAttributes = [
            "title" => trans("Edit")
        ];
        if ($modal) {
    ...
    public static function restoreButton($url, string $title = "Restore") {
        $customClass = ["btn-success", "restore-data"];
        $customAttributes = [
            "title" => trans($title),
        ];
    ...
    public static function trashButton($url) {
        $customClass = ["btn-danger", "trash-data"];
        $customAttributes = [
