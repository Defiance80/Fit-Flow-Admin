...
class WalletService
{
     ...
     */
    public static function creditWallet($userId, $amount, $transactionType, $description = null, $referenceId = null, $referenceType = null, $entryType = null)
    {
        return DB::transaction(function () use ($userId, $amount, $transactionType, $description, $referenceId, $referenceType, $entryType) {
     ...
     */
    public static function debitWallet($userId, $amount, $transactionType, $description = null, $referenceId = null, $referenceType = null, $entryType = null)
    {
        return DB::transaction(function () use ($userId, $amount, $transactionType, $description, $referenceId, $referenceType, $entryType) {
            $user = User::findOrFail($userId);
