...
class RazorpayCheckoutService implements PaymentGatewayContract
{
    public function initiate(Order $order, array $options = []): array
    {
        ...
        $paymentUrl = $this->generatePaymentUrl($rzpOrder['id'], $amount, $currency, $customerName, $customerEmail, $order->order_number, $type);
     ...
     */
    private function generatePaymentUrl($orderId, $amount, $currency, $customerName, $customerEmail, $orderNumber, $type = 'web')
    {
