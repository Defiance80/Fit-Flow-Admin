...
class ViewServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        /*** App Blade File ***/
        View::composer('layouts.app', static function (\Illuminate\View\View $view) {
            ...
            try {
                $settingLogos = HelperService::systemSettings(array('horizontal_logo','vertical_logo','favicon'));
        ...
        View::composer('*', static function (\Illuminate\View\View $view) {
