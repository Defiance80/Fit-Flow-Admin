...
class StoreCurriculumRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules['resource_data.*.resource_file'] = 'nullable|required_if:resource_data.*.resource_type,file,document,video,audio,image|file|mimes:' . implode(',', array_map('strtolower', $allowedDocs)) . '|max:5120';
