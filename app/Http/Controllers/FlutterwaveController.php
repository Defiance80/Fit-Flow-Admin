    ...
    public function handleFlutterwaveCallback(Request $request)
    {
        ...
        try {
            ...
            if (!$verificationResult['success']) {
                ...
                if ($type === 'app') {
                    return ApiResponseService::errorResponse('Transaction verification failed', [
    ...
    private function verifyFlutterwaveTransaction($txRef, $transactionId)
    {
        try {
            ...
            if ($responseData['status'] !== 'success') {
                return ['success' => false, 'message' => 'Flutterwave verification failed: ' . ($responseData['message'] ?? 'Unknown error')];
            }
