...
class WithdrawalController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $withdrawal = WithdrawalRequest::with(['user', 'processedBy'])
            ->where(function($q) {
    ...
    public function getWithdrawalData(Request $request)
    {
        ...
        $res = $res->map(function ($row) {
            ...
            if ($row->status === 'pending') {
                $operate .= '<a href="javascript:void(0)" class="btn btn-primary btn-xs edit-data" data-toggle="modal" data-target="#updateStatusModal" data-id="' . $row->id . '" title="Update Status"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;';
            }
