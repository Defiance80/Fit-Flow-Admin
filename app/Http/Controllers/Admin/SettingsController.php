...
class SettingsController extends Controller
{
    ...
    {
        $settings = CachingService::getSystemSettings(array('app_name', 'favicon', 'vertical_logo', 'horizontal_logo'));
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            foreach ($data as $name => $value) {
                ...
                $data = array('name' => $name, 'value' => $value, 'type' => $type);
            }
    ...
    {
        $settings = CachingService::getSystemSettings(array('firebase_api_key', 'firebase_auth_domain', 'firebase_project_id', 'firebase_storage_bucket', 'firebase_messaging_sender_id', 'firebase_app_id', 'firebase_measurement_id'));
    ...
    public function updateFirebase(Request $request)
    {
        ...
        try {
            ...
            $settingArray = [];
            foreach ($data as $name => $value) {
                $settingArray[] = array('name' => $name, 'value' => $value);
            }
    ...
    {
        $settings = CachingService::getSystemSettings(array('refund_policy', 'refund_period_days', 'refund_enabled'));
