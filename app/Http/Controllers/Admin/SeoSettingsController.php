...
class SeoSettingsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($existing) {
                ResponseService::validationError('SEO settings for this language and page type already exist. Please edit the existing entry.');
            }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            // Handle OG image upload
            if ($request->hasFile('og_image')) {
                $ogImagePath = FileService::compressAndReplace($request->file('og_image'), $this->uploadFolder, $seoSetting->getRawOriginal('og_image'));
            } else {
            ...
            ResponseService::successRedirectResponse("SEO settings updated successfully", route("admin.seo-settings.index"));
            ...
            if ($errorCode == 23000 || $errorCode == 1062 || str_contains($errorMessage, 'Duplicate entry') || str_contains($errorMessage, 'seo_settings_language_page_unique')) {
                ResponseService::validationError('SEO settings for this language and page type already exist. Please edit the existing entry.');
            } else {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if ($seoSetting->og_image) {
                FileService::delete($seoSetting->og_image, $this->uploadFolder);
            }
