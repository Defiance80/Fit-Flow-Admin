    ...
    try {
        ...
        if ($request->course_id) {
            ...
            $hasPurchased = Order::where('user_id', $user->id)
                ...
                ->whereHas('orderCourses', function ($q) use ($rateableId) {
        ...
        // --- Instructor review flow ---
            ...
            $hasPurchasedFromOwner = Order::where('user_id', $user->id)
                ->whereIn('status', ['completed'])
                ->whereHas('orderCourses.course', function ($q) use ($ownerUserId) {
    ...
    public function deleteRating(Request $request)
    {
        ...
        try {
            ...
            if ($request->filled('rating_id')) {
                ...
                if (!$rating) {
                    return ApiResponseService::errorResponse('Review not found or you do not have permission to delete it.');
                }
