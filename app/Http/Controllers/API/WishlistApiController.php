   ...
   public function getWishlist(Request $request)
{
    ...
    private function getFormattedWishlist()
    {
        ...
        $wishlistItems = $user->wishlists()->with([
        ...
        return $wishlistItems->map(function ($item) {
            ...
            if (Auth::check()) {
                if ($course->course_type === 'free') {
                    ...
                    $isEnrolled = OrderCourse::whereHas('order', function ($q) {
            ...
            return [
                ...
                'price' => isset($course->display_price) ? (float) $course->display_price : 0,
                'discounted_price' => $course->display_discount_price ?? null,
                'discount_percentage' => $discountPercentage,
                'is_wishlisted' => true, // Always true since these are from wishlist
                'is_enrolled' => $isEnrolled,
            ];
        })->filter()->values(); // Remove null items and ensure clean array indexes
    }
}
