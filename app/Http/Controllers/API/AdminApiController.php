...
class AdminApiController extends Controller
{
    ...
    public function updateAssignmentSubmission(Request $request)
    {
        try {
            ...
            // Get submission
            $submission = UserAssignmentSubmission::with(['assignment.chapter.course', 'user'])
            ...
            return ApiResponseService::successResponse('Assignment submission updated successfully by admin', $response);
    ...
    public function bulkUpdateAssignmentSubmissions(Request $request)
    {
        try {
            ...
            return ApiResponseService::successResponse(
                "Successfully updated {$updatedCount} assignment submissions",
                [
