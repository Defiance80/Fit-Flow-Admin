...
class InstallerController extends Controller
{
    ...
    public function checkPurchaseCode(Request $request)
    {
        try {
            ...
            $app_url = preg_replace('#^https?://#i', '', $app_url1).'/';
           
            $curl = curl_init();
            curl_setopt_array($curl, [
                CURLOPT_URL => 'https://validator.wrteam.in/elms_validator?purchase_code=' . $request->input('purchase_code') . '&domain_url=' . $app_url,
            ...
            EnvSet::setKey('APP_URL',  $app_url1);
            EnvSet::save();
