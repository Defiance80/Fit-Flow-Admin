                                                ...
                                                @switch($otherDetail->extension)
                                                    ...
                                                    @case('svg')
                                                        <div class="form-group">
                                                            ...
                                                            @if(!empty($otherDetail->value))
                                                                <a href="{{ $otherDetail->value }}" target="_blank" class="btn btn-primary">{{ __('View File') }}</a>
                                                            @endif
                                                        </div>
                                                        @break
                                                    ...
                                                    @case('docx')
                                                        <div class="form-group">
                                                            ...
                                                            @if(!empty($otherDetail->value))
                                                                <div>
                                                                    <a href="{{ $otherDetail->value }}" target="_blank" download class="btn btn-primary">{{ __('Download File') }}</a>
                                                                </div>
                                                            @endif
                                                        </div>
                                                        @break
