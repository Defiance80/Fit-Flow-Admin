                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-outline-secondary w-100" id="reset_request_filters" style="min-height: 38px; height: 38px; padding: 8px 16px; line-height: 1.5; white-space: nowrap; overflow: visible; text-overflow: clip; display: inline-flex; align-items: center; justify-content: center;">{{ __('Reset') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
