                                    ...
                                    <div class="course-learnings-section">
                                        <div data-repeater-list="learnings_data">
                                            <div class="row learning-section d-flex align-items-center mb-2" data-repeater-item>
                                                ...
                                                {{-- Learning --}}
                                                <div class="form-group mandatory col-md-10">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class="table" id="table_list" data-table="courses"data-toggle="table" data-url="{{ route('courses.show', 0) }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-use-row-attr-func="true" data-maintain-selected="true" data-export-data-type="all" data-export-options='{ "fileName": "{{ __('courses') }}-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}' data-show-export="true" data-query-params="courseQueryParams" data-table="course_chapters" data-status-column="is_active">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="is_active" data-formatter="statusFormatter" data-escape="false"> {{ __('Is Active') }}</th>
                                    <th scope="col" data-field="language.name" data-escape="true"> {{ __('Language') }}</th>
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="" data-escape="false">{{ __('Action') }}</th>
                                </tr>
                            </thead>
                        </table>
                        ...
                        <div class="row mt-3" id="toolbar">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="form-label mb-1 d-block" style="visibility: hidden;">{{ __('Reset') }}</label>
                                    <button type="button" class="btn btn-outline-secondary w-100" id="reset_filters" style="min-height: 38px; height: 38px; padding: 8px 16px; line-height: 1.5; white-space: nowrap; overflow: visible; text-overflow: clip; display: inline-flex; align-items: center; justify-content: center;">{{ __('Reset Filters') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
