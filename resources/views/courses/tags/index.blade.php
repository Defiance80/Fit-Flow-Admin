                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class="table reorder-table-row" id="table_list"
                            ...
                            data-export-options='{ "fileName": "{{ __('tags') }}-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="tagEvents" data-escape="false">{{ __('action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
