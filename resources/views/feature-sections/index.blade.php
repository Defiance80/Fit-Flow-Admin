                            ...
                            <table aria-describedby="mydesc" class="table reorder-table-row" id="table_list"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="type" data-escape="true">{{ __('Type') }}</th>
                                        ...
                                        <th data-field="operate" data-sortable="false" data-events="featureSectionAction" data-escape="false">{{ __('Action') }}</th>
                                    </tr>
                                </thead>
                            </table>
                            <span
