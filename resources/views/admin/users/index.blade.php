            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-bordered" id="table_list" 
                        ...
                        data-export-options='{ "fileName": "{{ __('users') }}-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="is_active" data-sortable="true" data-formatter="statusFormatter" data-escape="false">{{ __('Status') }}</th>
                                <th data-field="created_at" data-sortable="true" data-formatter="dateFormatter" data-escape="true">{{ __('Created At') }}</th>
                                <th data-field="operate" data-sortable="false" data-events="userEvents" data-escape="false">{{ __('Action') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
