                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="questions-table" class="table table-striped" 
                                   ...
                                   data-export-data-type="all" data-export-options='{"fileName": "questions-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}' 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="operate" data-sortable="false" data-events="questionAction" data-escape="false">{{ __('Action') }}</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
$(document).ready(function() {
    ...
    $('#group-filter, #privacy-filter').change(function() {
        $('#questions-table').bootstrapTable('refresh');
    });
