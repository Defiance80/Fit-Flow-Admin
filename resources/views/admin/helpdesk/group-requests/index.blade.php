                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="group-requests-table" class="table table-striped" 
                                   ...
                                   data-export-data-type="all" data-export-options='{"fileName": "group-requests-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}' 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="operate" data-sortable="false" data-events="groupRequestAction" data-escape="false">{{ __('Action') }}</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
$(document).ready(function() {
    ...
    $('#group-filter, #status-filter').change(function() {
        $('#group-requests-table').bootstrapTable('refresh');
    });
