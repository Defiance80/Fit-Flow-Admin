            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="{{ asset('img/avatar/avatar-1.png') }}" alt="User Avatar" class="rounded-circle" width="80" height="80">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ $rating->user->created_at->format('M d, Y') }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Total Ratings') }}:</strong></td>
                            <td>{{ $rating->user->ratings()->count() }}</td>
                        </tr>
                    </table>
                    @else
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ $rating->rateable->created_at->format('M d, Y') ?? 'N/A' }}</td>
                        </tr>
                    </table>
                    @else
                    <div class="text-center">
