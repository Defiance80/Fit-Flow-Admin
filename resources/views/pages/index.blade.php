                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class="table" id="table_list" data-table="pages" data-toggle="table" data-url="{{ route('pages.show', 0) }}" data-click-to-select="true"
                            ...
                            data-export-data-type="all" data-export-options='{ "fileName": "{{ __('pages') }}-<?= date('d-m-y') ?>","ignoreColumn":["operate"]}' data-show-export="true" data-query-params="pageQueryParams" data-status-column="status" data-table="pages" data-status-column="status">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="status" data-formatter="statusFormatter" data-escape="false">{{ __('Status') }}</th>
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="pageEvents" data-escape="false">{{ __('Action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
