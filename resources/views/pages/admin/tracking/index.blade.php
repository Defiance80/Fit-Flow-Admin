                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="progress mb-3" style="height: 20px;">
                                    <div class="progress-bar" role="progressbar" style="width: {{ $stats['average_progress'] }}%" aria-valuenow="{{ $stats['average_progress'] }}" aria-valuemin="0" aria-valuemax="100">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('admin.tracking.index') }}">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ __('Progress Status') }}</label>
                        ...
                        <tbody>
                            @foreach($trackings as $tracking)
                                <tr>
                                    <td>
                                        <div>
                                            <strong>{{ $tracking->user->name ?? 'N/A' }}</strong><br>
                                            <small class="text-muted">{{ $tracking->user->email ?? 'N/A' }}</small>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <strong>{{ $tracking->course->title ?? 'N/A' }}</strong><br>
                                            <small class="text-muted">{{ Str::limit($tracking->course->description ?? '', 50) }}</small>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.tracking.show', $tracking->id) }}" class="btn btn-sm btn-primary">
