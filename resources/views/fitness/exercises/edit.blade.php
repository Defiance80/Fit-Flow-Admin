@extends('layouts.app')
@section('title', __('Edit Exercise'))
@section('main')
<div class="main-content">
    <section class="section">
        <div class="section-header"><h1>{{ __('Edit Exercise') }}</h1></div>
        <div class="section-body"><div class="row"><div class="col-lg-8"><div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('exercises.update', $exercise') }}" method="POST">@csrf @method("PUT")
                    ...
                    <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save"></i> {{ __('Update Exercise') }}</button>
