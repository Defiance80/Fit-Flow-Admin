...
@section('page-title')
    ...
    <div class="section-header-button ml-auto"> <a class="btn btn-primary" href="{{ route('roles.create') }}"> + {{ __('Create New Role') }}</a></div> @endsection
                        ...
                        <table class="table table-border" id="table_list" data-toggle="table" data-url="{{ route('roles.list',0) }}"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="operate" data-align="center" data-escape="false">{{ __('Action') }}
                                    </th>
                                </tr>
                            </thead>
                        </table>
