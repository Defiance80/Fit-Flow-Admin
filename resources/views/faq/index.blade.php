                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class="table" id="table_list" data-table="faqs" data-toggle="table" data-url="{{ route('faqs.show', 0) }}" data-click-to-select="true"
                            ...
                            data-export-data-type="all"data-export-options='{ "fileName": "{{ __('faqs') }}-<?= date('d-m-y') ?>
                            ","ignoreColumn":["operate"]}' data-show-export="true" data-query-params="faqQueryParams" data-status-column="is_active" data-table="faqs">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="is_active" data-formatter="statusFormatter" data-escape="false" id="is-active-column">{{ __('Is Active') }}</th>
                                    <th scope="col" data-field="operate" data-sortable="false" data-events="faqEvents" data-escape="false">{{ __('Action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
