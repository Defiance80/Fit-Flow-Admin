...
use App\Http\Controllers\Fitness\TrainingProgramController;
use App\Http\Controllers\Fitness\ExerciseController;
use App\Http\Controllers\Fitness\MealPlanController;
use App\Http\Controllers\Health\HealthMetricController;
use App\Http\Controllers\Health\HealthAlertController;
...
Route::middleware([PanelAuthenticate::class])->group(function () {
    ...
    Route::get('/instructor-terms-settings', [SettingsController::class, 'instructorTerms'])->name('settings.instructor-terms');
    Route::post('/instructor-terms-settings', [SettingsController::class, 'updateInstructorTerms'])->name('settings.instructor-terms.update');

    // Why Choose Us Settings
    Route::get('/why-choose-us-settings', [SettingsController::class, 'whyChooseUs'])->name('settings.why-choose-us');
    Route::post('/why-choose-us-settings', [SettingsController::class, 'updateWhyChooseUs'])->name('settings.why-choose-us.update');
    ...
    Route::get('/become-instructor-settings', [SettingsController::class, 'becomeInstructor'])->name('settings.become-instructor');
    ...
    Route::put('seo-settings/{id}/restore', [\App\Http\Controllers\Admin\SeoSettingsController::class, 'restore'])->name('admin.seo-settings.restore');
    Route::delete('seo-settings/{id}/trash', [\App\Http\Controllers\Admin\SeoSettingsController::class, 'trash'])->name('admin.seo-settings.trash');
    Route::post('/become-instructor-settings', [SettingsController::class, 'updateBecomeInstructor'])->name('settings.become-instructor.update');


    

    // Social Media Settings Routes
    Route::delete('/settings/social-medias/{id}', [SettingsController::class, 'destroySocialMedia'])->name('settings.social-medias.destroy');
    ...
    Route::get('/payment-gateway-settings', [SettingsController::class, 'paymentGateway'])->name('settings.payment-gateway');
    Route::post('/payment-gateway-settings', [SettingsController::class, 'updatePaymentGateway'])->name('settings.payment-gateway.update');
    ...
    Route::group(['prefix' => 'language'], static function () {
        ...
        Route::get('download-sample/{type}', [LanguageController::class, 'downloadSampleFile'])->name('language.download.sample');
        ...
        Route::post('auto-translate/{id}/{type}/{locale}', [LanguageController::class, 'autoTranslate'])->name('language.auto-translate');
        ...
        Route::get('test-auto-translate/{id}', function($id) {
            ...
            foreach ($enContent as $key => $englishValue) {
                $currentValue = isset($targetContent[$key]) ? trim($targetContent[$key]) : '';
    ...
    Route::group(['prefix' => 'category'], static function () {
        ...
        Route::get('/{id}/sub-category/change-order', [CategoryController::class, 'subcategoriesOrder'])->name('sub.category.order.change');
    });
    /***************************************************************************************************** */

    // custom-fields Module
    Route::put('custom-form-fields/update-rank', [CustomFormFieldController::class, 'updateRankOfFields']);
    Route::delete('custom-form/default-value/{id}', [CustomFormFieldController::class, 'deleteOption'])->name('custom-form.default-value.destroy');
    Route::put('custom-form-fields/{id}/restore',[CustomFormFieldController::class,'restore'])->name('custom-form-fields.restore');
    Route::delete('custom-form-fields/{id}/trash',[CustomFormFieldController::class,'trash'])->name('custom-form-fields.trash');
    ...
    Route::put('/feature-sections/{id}/restore', [FeatureSectionController::class, 'restore'])->name('feature-sections.restore');
    Route::delete('/feature-sections/{id}/trash', [FeatureSectionController::class, 'trash'])->name('feature-sections.trash');
    ...
    Route::post('certificates/{certificate}/toggle-status', [\App\Http\Controllers\Admin\CertificateController::class, 'toggleStatus'])->name('admin.certificates.toggle-status');
    Route::get('certificates/{certificate}/preview', [\App\Http\Controllers\Admin\CertificateController::class, 'preview'])->name('admin.certificates.preview');
    Route::get('certificates/{certificate}/editor', [\App\Http\Controllers\Admin\CertificateController::class, 'editor'])->name('admin.certificates.editor');
    Route::post('certificates/{certificate}/update-design', [\App\Http\Controllers\Admin\CertificateController::class, 'updateDesign'])->name('admin.certificates.update-design');
    ...
    Route::group(['prefix' => 'courses'], function () {
        ...
        Route::delete('{id}/learnings', [CoursesController::class, 'destroyLearnings'])->name('courses.learnings.destroy'); // destroy learnings
        ...
        Route::post('{id}/requirements', [CoursesController::class, 'storeRequirements'])->name('courses.requirements.store'); // store requirements
        Route::delete('{id}/requirements', [CoursesController::class, 'destroyRequirements'])->name('courses.requirements.destroy'); // destroy requirements
        // Courses Main Routes
        ...
        Route::delete('languages/{id}', [CoursesController::class, 'languagesDestroy'])->name('courses.languages.destroy');
        Route::put('languages/{id}/restore', [CoursesController::class, 'languagesRestore'])->name('courses.languages.restore');
        Route::delete('languages/{id}/trash', [CoursesController::class, 'languagesTrash'])->name('courses.languages.trash');
    ...
    Route::group(['prefix' => 'course-chapters'], function () {
        Route::get('{id}/curriculum', [CourseChaptersController::class, 'curriculumIndex'])->name('course-chapters.curriculum.index');
        Route::post('{id}/curriculum', [CourseChaptersController::class, 'curriculumStore'])->name('course-chapters.curriculum.store');
        Route::get('{id}/curriculum/list', [CourseChaptersController::class, 'getCurriculumDataList'])->name('course-chapters.curriculum.list');
        Route::put('{id}/curriculum/change-status', [CourseChaptersController::class, 'changeCurriculumStatus'])->name('course-chapters.curriculum.change-status');
        Route::get('{id}/{type}/particular-curriculum/details', [CourseChaptersController::class, 'getParticularCurriculumDetails'])->name('course-chapters.curriculum.particular-details');
        Route::get('{id}/{type}/curriculum/edit', [CourseChaptersController::class, 'curriculumEdit'])->name('course-chapters.curriculum.edit');
        Route::delete('{id}/{type}/curriculum/destroy', [CourseChaptersController::class, 'curriculumDestroy'])->name('course-chapters.curriculum.destroy');
        Route::get('{id}/curriculum/trashed', [CourseChaptersController::class, 'getTrashedCurriculumList'])->name('course-chapters.curriculum.trashed');
        Route::put('{id}/{type}/curriculum/restore', [CourseChaptersController::class, 'restoreCurriculum'])->name('course-chapters.curriculum.restore');
       
        // Update Lecture Curriculum
        Route::put('{id}/curriculum/lecture/update', [CourseChaptersController::class, 'curriculumLectureUpdate'])->name('course-chapters.curriculum.lecture.update');
        // Update Resource Curriculum
        Route::put('{id}/curriculum/resource/update', [CourseChaptersController::class, 'curriculumResourceUpdate'])->name('course-chapters.curriculum.resource.update');
        // Update Quiz Curriculum
        Route::put('{id}/curriculum/quiz/update', [CourseChaptersController::class, 'curriculumQuizUpdate'])->name('course-chapters.curriculum.quiz.update');
        // Update Assignment Curriculum
        Route::put('{id}/curriculum/assignment/update', [CourseChaptersController::class, 'curriculumAssignmentUpdate'])->name('course-chapters.curriculum.assignment.update');

        // Quiz Questions Routes
        Route::get('{id}/quiz/questions/list', [CourseChaptersController::class, 'quizQuestionsList'])->name('course-chapters.quiz.questions.list');
        Route::put('{id}/quiz/questions/update', [CourseChaptersController::class, 'quizQuestionsUpdate'])->name('course-chapters.quiz.questions.update');
        Route::delete('{id}/quiz/questions/destroy', [CourseChaptersController::class, 'quizQuestionsDestroy'])->name('course-chapters.quiz.questions.destroy');
        Route::get('{id}/{type}/curriculum/reorder', [CourseChaptersController::class, 'reorder'])->name('course-chapters.curriculum.reorder');
        Route::put('{id}/{type}/curriculum/reorder-update', [CourseChaptersController::class, 'reorderUpdate'])->name('course-chapters.curriculum.reorder-update');
        
        // Curriculum reorder all items (inline) - using standard pattern
        Route::put('{id}/curriculum/update-rank', [CourseChaptersController::class, 'updateRankOfCurriculum'])->name('course-chapters.curriculum.update-rank');
    ...
    Route::put('course-chapters/{id}/restore', [CourseChaptersController::class, 'restore'])->name('course-chapters.restore');
    Route::delete('course-chapters/{id}/trash', [CourseChaptersController::class, 'trash'])->name('course-chapters.trash'); // force delete
    ...
    Route::put('instructor/status-update/{id}', [InstructorController::class, 'updateStatus'])->name('instructor.status.update');
    Route::get('instructor-wallet-history', [InstructorController::class, 'walletHistory'])->name('instructor.wallet-history');
    Route::get('instructor-wallet-history-data', [InstructorController::class, 'getWalletHistoryData'])->name('instructor.wallet-history.data');
    Route::get('instructor-withdrawal-requests', [InstructorController::class, 'withdrawalRequests'])->name('instructor.withdrawal-requests');
    ...
    Route::get('test-withdrawal-page', function() {
        try {
            $count = \App\Models\WithdrawalRequest::count();
            return response("Test page works! Withdrawal count: " . $count, 200)
    ...
    Route::get('instructor-withdrawal-requests-data', [InstructorController::class, 'getWithdrawalRequestsData'])->name('instructor.withdrawal-requests.data');
    Route::post('instructor-withdrawal-request-update-status', [InstructorController::class, 'updateWithdrawalRequestStatus'])->name('instructor.withdrawal-request.update-status');
    /***************************************************************************************************** */
    ...
    Route::prefix('helpdesk')->group(function(){
        Route::put('groups/update-rank', [HelpdeskGroupController::class, 'updateRankOfGroups'])->name('helpdesk.groups.update-rank');
    ...
    Route::prefix('admin/helpdesk')->name('admin.helpdesk.')->group(function(){
        // Group Requests
        Route::get('group-requests', [App\Http\Controllers\Admin\HelpdeskGroupRequestController::class, 'index'])->name('group-requests.index');
        Route::get('group-requests/{id}', [App\Http\Controllers\Admin\HelpdeskGroupRequestController::class, 'show'])->name('group-requests.show');
        Route::post('group-requests/{id}/status', [App\Http\Controllers\Admin\HelpdeskGroupRequestController::class, 'updateStatus'])->name('group-requests.update-status');
        Route::get('group-requests/dashboard/data', [App\Http\Controllers\Admin\HelpdeskGroupRequestController::class, 'getDashboardData'])->name('group-requests.dashboard');
        
        // Questions
        Route::get('questions', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'index'])->name('questions.index');
        Route::get('questions/{id}', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'show'])->name('questions.show');
        Route::get('questions/slug/{slug}', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'showBySlug'])->name('questions.show.slug');
        Route::get('questions/{id}/edit', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'edit'])->name('questions.edit');
        Route::put('questions/{id}', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'update'])->name('questions.update');
        Route::delete('questions/{id}', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'destroy'])->name('questions.destroy');
        Route::put('questions/{id}/restore', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'restore'])->name('questions.restore');
        Route::delete('questions/{id}/trash', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'trash'])->name('questions.trash');
        Route::get('questions/dashboard/data', [App\Http\Controllers\Admin\HelpdeskQuestionController::class, 'getDashboardData'])->name('questions.dashboard');
        
        // Replies
        Route::get('replies', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'index'])->name('replies.index');
        Route::get('replies/{id}', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'show'])->name('replies.show');
        Route::get('replies/{id}/edit', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'edit'])->name('replies.edit');
        Route::put('replies/{id}', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'update'])->name('replies.update');
        Route::delete('replies/{id}', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'destroy'])->name('replies.destroy');
        Route::get('replies/dashboard/data', [App\Http\Controllers\Admin\HelpdeskReplyController::class, 'getDashboardData'])->name('replies.dashboard');
    });
    ...
    Route::prefix('withdrawals')->name('admin.withdrawals.')->group(function(){
        ...
        Route::get('/data', [App\Http\Controllers\Admin\WithdrawalController::class, 'getWithdrawalData'])->name('data');
        Route::get('/{id}', [App\Http\Controllers\Admin\WithdrawalController::class, 'show'])->name('show');
        Route::post('/{id}/update-status', [App\Http\Controllers\Admin\WithdrawalController::class, 'updateStatus'])->name('update-status');
    });
    ...
    Route::prefix('ratings')->name('admin.ratings.')->group(function(){
        ...
        Route::get('/dashboard/data', [App\Http\Controllers\Admin\RatingController::class, 'getDashboardData'])->name('dashboard.data');
    });
    ...
    Route::prefix('orders')->name('admin.orders.')->group(function(){
        ...
        Route::patch('/{id}/status', [App\Http\Controllers\Admin\OrdersController::class, 'updateStatus'])->name('update-status');
        Route::get('/dashboard/data', [App\Http\Controllers\Admin\OrdersController::class, 'getDashboardData'])->name('dashboard.data');
    });
    ...
    Route::prefix('enrollments')->name('admin.enrollments.')->group(function(){
        ...
        Route::get('/dashboard/data', [App\Http\Controllers\Admin\EnrollmentController::class, 'getDashboardData'])->name('dashboard.data');
    });
    ...
    Route::prefix('tracking')->name('admin.tracking.')->group(function(){
        ...
        Route::patch('/{id}/progress', [App\Http\Controllers\Admin\TrackingController::class, 'updateProgress'])->name('update-progress');
        Route::get('/dashboard/data', [App\Http\Controllers\Admin\TrackingController::class, 'getDashboardData'])->name('dashboard.data');
    });
    ...
    Route::prefix('assignments')->name('admin.assignments.')->group(function(){
        ...
        Route::get('/pending', [App\Http\Controllers\Admin\AssignmentController::class, 'pending'])->name('pending');
        Route::get('/accepted', [App\Http\Controllers\Admin\AssignmentController::class, 'accepted'])->name('accepted');
        Route::get('/rejected', [App\Http\Controllers\Admin\AssignmentController::class, 'rejected'])->name('rejected');
        ...
        Route::patch('/{id}/status', [App\Http\Controllers\Admin\AssignmentController::class, 'updateStatus'])->name('update-status');
        Route::patch('/bulk-update', [App\Http\Controllers\Admin\AssignmentController::class, 'bulkUpdate'])->name('bulk-update');
        Route::get('/dashboard/data', [App\Http\Controllers\Admin\AssignmentController::class, 'getDashboardData'])->name('dashboard.data');
    });
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::get('/commission-data', [ReportsController::class, 'getCommissionReportData'])->name('reports.commission.data');
        Route::get('/course-data', [ReportsController::class, 'getCourseReportData'])->name('reports.course.data');
                        Route::get('/instructor-data', [ReportsController::class, 'getInstructorReportData'])->name('reports.instructor.data');
                Route::get('/enrollment-data', [ReportsController::class, 'getEnrollmentReportData'])->name('reports.enrollment.data');
        ...
        Route::post('/commission/export', [ReportsController::class, 'exportCommissionReport'])->name('reports.commission.export');
        Route::post('/course/export', [ReportsController::class, 'exportCourseReport'])->name('reports.course.export');
        Route::post('/instructor/export', [ReportsController::class, 'exportInstructorReport'])->name('reports.instructor.export');
        Route::post('/enrollment/export', [ReportsController::class, 'exportEnrollmentReport'])->name('reports.enrollment.export');
        Route::post('/revenue/export', [ReportsController::class, 'exportRevenueReport'])->name('reports.revenue.export');
    });
    ...
    Route::prefix("health")->group(function () {
        Route::get("metrics", [HealthMetricController::class, "index"])->name("health.metrics.index");
        Route::get("metrics/{client}", [HealthMetricController::class, "show"])->name("health.metrics.show");
        Route::get("alerts", [HealthAlertController::class, "index"])->name("health.alerts.index");
        Route::post("alerts/{alert}/acknowledge", [HealthAlertController::class, "acknowledge"])->name("health.alerts.acknowledge");
    });
    Route::resource("schedules", ScheduleController::class);
    Route::resource("facilities", FacilityController::class);
    Route::resource("subscriptions", SaasSubscriptionController::class)->only(["index", "show", "update"]);
    /***************************************************************************************************** */
...
Route::get('/flutterwave-callback', [FlutterwaveController::class, 'handleFlutterwaveCallback'])->name('flutterwave-callback');
